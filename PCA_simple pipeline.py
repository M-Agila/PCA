...
conn = engine.connect()
# **Import the data**
University = pd.read_excel(r"C:\Users\agila\OneDrive\Desktop\data_science\PCA_code\University_Clustering.xlsx")
University
...
df = pd.read_sql_table('university_clustering', conn)
...
newdf = pd.read_excel(r"C:\Users\agila\OneDrive\Desktop\data_science\PCA_code\new_Univ_4_pred.xlsx")
newdf
